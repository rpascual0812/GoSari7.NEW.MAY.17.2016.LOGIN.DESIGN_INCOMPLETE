...
public class ViewCategory extends AppCompatActivity
    ...
    public void ViewCheckOutCart(){
        Intent viewCheckOutCart=new Intent(getApplicationContext(),ViewCart.class);
        startActivity(viewCheckOutCart);
    }
